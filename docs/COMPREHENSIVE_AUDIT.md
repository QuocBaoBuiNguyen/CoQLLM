...
| 5 | **User-conditioned queries** | `feat/user-conditioned-queries` (2478f3f) | `SigLLM.ipynb` | **0.7060** (ep3) / 0.7152 (07-20 rerun) | 🛑 test 0.7086/0.7287 từ eval path nghi vấn — corrected `eval_test.py`: no collapse, uAUC vẫn ≤ baseline (xem warning §2) | ✓ |
