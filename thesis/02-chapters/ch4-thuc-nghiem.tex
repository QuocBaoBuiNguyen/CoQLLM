...
tổn thất này tác động vào thứ tự nội-người-dùng chứ không ảnh hưởng đến khả năng phân biệt
giữa các người dùng.
Con số $0{,}6062$ đưa SigLLM vào vùng cạnh tranh với CoRA-MF ($0{,}6262$), vốn dùng cơ chế
tiêm trọng số khác hẳn.

\textit{Về giao thức so sánh.} SigLLM chọn checkpoint theo \textbf{uAUC}, còn
