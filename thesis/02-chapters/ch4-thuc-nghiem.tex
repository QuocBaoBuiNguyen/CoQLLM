...
khác biệt quy trình: SigLLM chọn checkpoint tốt nhất theo \textbf{uAUC}, trong khi
...
\begin{table}[ht]
\caption{Kết quả trên MovieLens-1M (quy trình CoLLM-parity). SigLLM báo cáo hai cấu hình:
...
\textit{Về quy trình so sánh.} SigLLM chọn checkpoint theo \textbf{uAUC}, còn
...
\begin{enumerate}
    ...
    khác quy trình chọn checkpoint theo uAUC của SigLLM.
