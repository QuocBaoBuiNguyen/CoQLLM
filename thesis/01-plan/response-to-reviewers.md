# Response to Reviewers — Luận văn CoQLLM (vòng revision ARS)
...
- Ghi rõ khác biệt protocol: CoQLLM chọn checkpoint theo **uAUC**, CoLLM/CoRA theo **AUC** (ghi chú tại bảng kết quả + §hạn-chế).
