...
import torch
from coqllm.common.dist_utils import download_cached_file
from coqllm.common.logging_utils import NotebookLogger
from coqllm.common.utils import is_url
from coqllm.models.multimodal.base.base_model import BaseModel
from coqllm.models.rec.matrix_factorization import MatrixFactorization

LOGGER = NotebookLogger.rich_logger("coqllm.rec_base_model")
