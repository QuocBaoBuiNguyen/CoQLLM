...
from coqllm.common import NotebookLogger, EarlyStopping
from coqllm.common.config import Config
from coqllm.datasets.qformer.qformer_loader import build_qformer_loaders
from coqllm.models.rec.matrix_factorization import MatrixFactorization
from coqllm.models.q_former.hf_qformer_adapter import HFQFormerAdapter
from coqllm.models.projection.qformer_alignment_model import QRecInstructAlignmentModel

os.environ["TOKENIZERS_PARALLELISM"] = "false"

LOGGER = NotebookLogger.rich_logger("coqllm.train_qformer_stage1")
...
def train_step(
    ...
    CoQ-LLM-specific item-item and (ILM-style) user-item contrastives."""
